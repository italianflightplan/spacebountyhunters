SCHEMA.name = "Space Bounty Hunters!"
SCHEMA.introName = ""
SCHEMA.desc = " "
SCHEMA.author = ""
SCHEMA.uniqueID = "Space Bounty Hunters!" -- Schema will be a unique identifier stored in the database.

nut.currency.set("", "favor", "favors")
